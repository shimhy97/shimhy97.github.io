...
공개 글의 최종 어투와 구조는 별도 문서인 `docs/weekly-tech-roundup-writing-guide.md`를 기준으로 삼는다.
...
선택된 항목만 대상으로 한국어 초안을 만든다. 내부 요약 데이터는 일관되게 유지하되, 공개 글은 `docs/weekly-tech-roundup-writing-guide.md`의 규약에 따라 서술형 문단으로 재구성한다.
...
운영자가 PR을 merge하면 기존 [pages.yml](../.github/workflows/pages.yml) 이 `main` 브랜치 변경을 감지해 GitHub Pages를 다시 배포한다.
...
- 공개 글 작성 규약: `docs/weekly-tech-roundup-writing-guide.md`
