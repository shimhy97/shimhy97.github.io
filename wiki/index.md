...
- [overview.md](overview.md): 블로그 위키의 범위, 독자, 콘텐츠 축, 발행 원칙을 요약한다.
- [log.md](log.md): ingest, query, lint, publish 이력을 시간순으로 기록한다.
- [../docs/technical-post-writing-guide.md](../docs/technical-post-writing-guide.md): 공개 기술 글 작성의 단일 기준 문서다.
- [../docs/blog-engineering-guide.md](../docs/blog-engineering-guide.md): 요약 박스, 본문 폭, figure, notice 같은 게시 형식 기준을 정리한다.
...
- [sources/melu-cold-start-recommendation.md](sources/melu-cold-start-recommendation.md): MeLU 논문을 few-shot 콜드스타트 추천 관점에서 요약한다.
...
- [topics/few-shot-cold-start-recommendation.md](topics/few-shot-cold-start-recommendation.md): 새 유저 onboarding을 메타러닝 기반 few-shot 적응 문제로 읽는 관점을 정리한다.
...
- [drafts/2026-04-09-melu-few-shot-cold-start-recommendation.md](drafts/2026-04-09-melu-few-shot-cold-start-recommendation.md): MeLU 논문을 0-shot이 아닌 few-shot 추천 흐름으로 해설한 발행 초안이다.
